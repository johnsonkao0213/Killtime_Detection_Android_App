package labelingStudy.nctu.boredom_detection.view.customview;
...
public class PinchRecyclerView extends RecyclerView {
    private static final String TAG = "PinchRecyclerView";
...
*/
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            Log.i(TAG, "detector.getScaleFactor(): " + detector.getScaleFactor());
