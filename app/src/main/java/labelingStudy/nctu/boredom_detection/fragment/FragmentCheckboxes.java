...
import labelingStudy.nctu.boredom_detection.model.Question;
...
public class FragmentCheckboxes extends Fragment {
    ...
    private TextView textview_q_title, textview_q_desc;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textview_q_desc = (TextView) rootView.findViewById(R.id.textview_q_desc);
...
//            Answers.getInstance().put_answer(token, the_choices);
        }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        textview_q_desc.setText(q_data != null ? q_data.getDescription() : "");

        token = q_data != null ? q_data.getToken() : "";
