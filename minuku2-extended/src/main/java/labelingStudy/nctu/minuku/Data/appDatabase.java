...
@Database(entities = {SensorDataRecord.class, AccessibilityDataRecord.class, MobileAccessibilityDataRecord.class,
...
public abstract class appDatabase extends RoomDatabase {
    ...
    public abstract MobileAccessibilityDataRecordDAO mobileAccessibilityDataRecordDAO();
