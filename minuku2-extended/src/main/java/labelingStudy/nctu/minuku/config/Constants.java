...
public class Constants {
    ...
    public static final String UPLOAD_CHANNEL_NAME = "BD";
    public static final String UPLOAD_CHANNEL_ID = "upload_id";
    public static final String UPLOAD_DATA_CHANNEL_NAME = "BD";
    public static final String UPLOAD_DATA_CHANNEL_ID = "upload_data_id";
    ...
    //sharedPrefs
    public static final String sharedPrefString = "labelingStudy.nctu.boredom_detection";

    //file path
    public static final String PACKAGE_DIRECTORY_PATH = "/Android/data/labelingStudy.nctu.boredom_detection/";
