...
public class TransportationModeStreamGenerator extends AndroidStreamGenerator<TransportationModeDataRecord> {
    ...
    private static final String PACKAGE_DIRECTORY_PATH="/Android/data/labelingStudy.nctu.boredom_detection/";
...
//                    .build();
            id = transportationModeDataRecordDAO.insertAll(transportationModeDataRecord);
