...
public class AppUsageStreamGenerator extends AndroidStreamGenerator<AppUsageDataRecord>{
    ...
    private static String mLastestForegroundPackage= "NA"; //Latest_Foreground_Package
...
//        getAppUsageUpdate();
        ...
        String app = getAppNamebyPackageName(mLastestForegroundPackage);
        Log.d(TAG,"Screen_Status : "+Screen_Status+" mLastestForegroundApp: "+ app +" LastestForegroundPackage : "+mLastestForegroundPackage+" LastestForegroundActivity : "+mLastestForegroundActivity);
...
//        int session_id = SessionManager.getOngoingSessionId();
        ...
        AppUsageDataRecord appUsageDataRecord = new AppUsageDataRecord(Screen_Status,app,mLastestForegroundPackage,mLastestForegroundActivity);
        ...
        if(appUsageDataRecord!=null) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                ...
                Log.d(TAG, "AppUsage to be sent to event bus" + appUsageDataRecord);
...
//                            .build();
                    id = appUsageDataRecordDAO.insertAll(appUsageDataRecord);
                    if(debugMode) {
