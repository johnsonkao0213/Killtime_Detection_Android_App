...
//                        .build();
                id = activityRecognitionDataRecordDAO.insertAll(activityRecognitionDataRecord);
                if(debugMode){
...
//            });
    ...
    public void saveRecordToLocalRecordPool(DetectedActivity MostProbableActivity,long Detectedtime) {
        ...
        //record.set
        //record.setData(data);
        record.setCreationTime(sLatestDetectionTime);

        Log.d(TAG, "testing saving records at " + record.getCreationTime() + " data: ");
    ...
    protected void addRecord(ActivityRecognitionDataRecord activityRecognitionDataRecord) {
        ...
        //Log.e(TAG, mLocalRecordPool.size()+"");
        ...
        try {
            ...
            transportationModeStreamGenerator.updateStream();
            /*
    ...
    protected void removeOutDatedRecord() {
        ...
        for (int i=0; i<mLocalRecordPool.size(); i++) {
            ...
            //Log.e(TAG, "diff "+ diff +", "+ mLocalRecordPool.get(i).getCreationTime());
