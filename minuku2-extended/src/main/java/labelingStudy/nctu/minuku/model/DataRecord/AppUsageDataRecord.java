...
public class AppUsageDataRecord implements DataRecord {
    ...
    @ColumnInfo(name = "Latest_Foreground_Package")
    public String Latest_Foreground_Package;
    ...
    public AppUsageDataRecord(String Screen_Status, String Latest_Used_App, String Latest_Foreground_Package, String Latest_Foreground_Activity) {
        ...
        this.Latest_Foreground_Package = Latest_Foreground_Package;
    }
    @Ignore
    ...
    public String getLatest_Foreground_Package() {
        return Latest_Foreground_Package;
    }

    public void setLatest_Foreground_Package(String latest_Foreground_Package) {
        Latest_Foreground_Package = latest_Foreground_Package;
    }
